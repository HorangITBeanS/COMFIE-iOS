...
struct MemoStoreComfieZoneMappingTests {
    // 시나리오: plainModeDeletingCharacterRemovesEmojiAtSamePositionOnUpdate 동작을 검증합니다.
    ...
    // 시나리오: plainModeReplacingCharacterRemapsEmojiAtEditedPositionOnUpdate 동작을 검증합니다.
